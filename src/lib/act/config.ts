// Auto-generated shim — re-exports from @/lib/cambridge-igcse-mathematics/config
// This lets shared ecosystem components import from "@/lib/act/config"
import type { ExamConfig as _cambridge_igcse_mathematics_Config } from "@/lib/cambridge-igcse-mathematics/config";
import { EXAM_CONFIG as _raw } from "@/lib/cambridge-igcse-mathematics/config";
