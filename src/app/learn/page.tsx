...
export const metadata: Metadata = {
  title: "Learn — Cambridge IGCSE Mathematics Practice",
  description: "Study and practice for Cambridge IGCSE Mathematics. Choose your subject and start preparing.",
};
    ...
    <main className="min-h-screen px-4 py-12">
      <div className="mx-auto max-w-4xl">
        ...
        <h1 className="mb-2 text-3xl font-bold text-zinc-900 dark:text-zinc-100">
          Cambridge IGCSE Mathematics Study Hub
        </h1>
