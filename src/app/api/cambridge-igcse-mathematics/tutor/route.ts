...
const EXAM_ID = "cambridge-igcse-mathematics";
const EXAM_DISPLAY_NAME = "Cambridge IGCSE Mathematics";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Number, Algebra and Graphs, Geometry, Mensuration, Co-ordinate Geometry, Trigonometry, Vectors, Probability, and Statistics. Align to Cambridge IGCSE 0580.
