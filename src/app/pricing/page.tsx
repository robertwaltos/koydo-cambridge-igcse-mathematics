...
export const metadata: Metadata = {
  title: "Pricing — Cambridge Igcse Mathematics Premium",
  description: "Unlock unlimited Cambridge Igcse Mathematics practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=cambridge-igcse-mathematics&cadence=annual`;
    ...
    <main className="min-h-screen px-4 py-12">
      <div className="mx-auto max-w-3xl text-center">
        ...
        <h1 className="mb-4 text-3xl font-bold text-zinc-900 dark:text-zinc-100">
          Cambridge Igcse Mathematics Premium
        </h1>
